...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jurusan1.put(DatabaseContract.TbJurusan.COLUMN_NAME_NAMA_JURUSAN, "TIF");
        jurusan2.put(DatabaseContract.TbJurusan.COLUMN_NAME_NAMA_JURUSAN, "SI");
        ...
        _txResult.append(_crudHelper.getDosen(null).get(0).get("nama") + " " + _crudHelper.getDosen(null).get(0).get("id") +
                " " + _crudHelper.getDosen(null).get(0).get("email") + System.getProperty("line.separator"));

        _txResult.append(_crudHelper.getMahasiswa(null).get(0).get("nama") + " " +
                _crudHelper.getMahasiswa(null).get(0).get("dosenPa") + " " + _crudHelper.getMahasiswa(null).get(0).get("jurusan") +
                System.getProperty("line.separator"));
        //
        // _txResult.append("select hasil transaksi"+ System.getProperty ("line.separator"));
        //  _txResult.append(_crudHelper.getMahasiswa(null).get(2).get("nama")+" "+_crudHelper.getMahasiswa(null).get(2).get("dosenPa")+
        //  System.getProperty ("line.separator"));
        // _txResult.append(_crudHelper.getMahasiswa(null).get(3).get("nama") + " "+_crudHelper.getMahasiswa(null).get(3).get("dosenPa")+
        // System.getProperty ("line.separator"));
