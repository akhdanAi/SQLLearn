...
public class CrudHelper {
    ...
    public long insertDosen(ContentValues values) {
        ...
        //nullColumnHack menentukan kolom mana yang ingin diisi dengan nilai null, jika  tdk ingin
        //memberi nilai null maka isi parameter tsb dgn nilai null
    ...
    public ArrayList<HashMap<String, String>> getMahasiswa(@Nullable String _id) {
        ...
        String[] projection = {
                ...
                DatabaseContract.TbMahasiswa.COLUMN_NAME_NAMA + " as NamaMhs", //biar tidak ambigu nama kolom "nama" di
                //dosen dan mahasiswa
                ...
                DatabaseContract.TbJurusan.TABLE_NAME + "." + DatabaseContract.TbJurusan.COLUMN_NAME_NAMA_JURUSAN};

        String selection = DatabaseContract.TbMahasiswa.TABLE_NAME + "." + DatabaseContract.TbMahasiswa.COLUMN_NAME_ID_DOSENPA + " = " +
        ...
        if (_id != null) {
            ...
            selection = DatabaseContract.TbMahasiswa.TABLE_NAME + "." + DatabaseContract.TbMahasiswa.COLUMN_NAME_ID_DOSENPA + " = " +
                    DatabaseContract.TbDosen.TABLE_NAME + "." + DatabaseContract.TbDosen._ID + " AND " + DatabaseContract.TbMahasiswa.TABLE_NAME + "." +
                    BaseColumns._ID + " = ?";
        ...
        Cursor cursor = db.query(
                DatabaseContract.TbMahasiswa.TABLE_NAME + " , " + DatabaseContract.TbDosen.TABLE_NAME,
                // The table to query
        ...
        while (cursor.moveToNext()) {
            ...
            String jurusan = cursor.getString(
                    cursor.getColumnIndexOrThrow(DatabaseContract.TbJurusan.TABLE_NAME + "." +
                            DatabaseContract.TbJurusan.COLUMN_NAME_NAMA_JURUSAN));
    ...
    public ArrayList<HashMap<String, String>> getJurusan(@Nullable String _id) {
        ...
        String sortOrder =
                DatabaseContract.TbJurusan.COLUMN_NAME_NAMA_JURUSAN + " DESC";
        Cursor cursor = db.query(
        ...
        while (cursor.moveToNext()) {
            ...
            String nama = cursor.getString(
                    cursor.getColumnIndexOrThrow(DatabaseContract.TbJurusan.COLUMN_NAME_NAMA_JURUSAN));
    ...
    //update
    public int updateMahasiswa(String id, ContentValues
            cv) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
